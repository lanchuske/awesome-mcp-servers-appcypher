...
- <img src="https://cdn.simpleicons.org/apple/999999" height="14"/> [Local MCP](https://github.com/lanchuske/local-mcp-releases) - Native macOS MCP server with 111 tools for Mail, Calendar, Contacts, Teams, Slack, WhatsApp, OneDrive, Notes, Reminders, OmniFocus, iMessage, and Safari. No cloud, no API keys — all data stays on your Mac.
